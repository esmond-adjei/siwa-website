    ...
    >
      ...
      <div className="absolute bottom-0 inset-x-0 p-6 md:p-8 lg:p-10 flex flex-col justify-end">
        ...
        <div className="relative z-10">
          <span className="inline-block mb-3 px-4 py-1.5 rounded-full text-xs md:text-sm font-semibold text-white bg-white/20 backdrop-blur-md border border-white/20 shadow-xs">
            {impact.impact}
          </span>
        ...
        >
          <p className="text-white/90 text max-w-2xl">
            {impact.description}
          </p>
        </motion.div>

        {/* Mobile Fallback: Always visible, no animation */}
